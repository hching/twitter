...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *dateString = [displayFormat stringFromDate:tweet.tweetTime];
    cell.timeLabel.text = [NSString stringWithFormat:@"%@", dateString];
    [cell.timeLabel sizeToFit];
    
    NSData *profileImageData = [NSData dataWithContentsOfURL:tweet.profileImage];
    [cell.profileImage setImage:[UIImage imageWithData:profileImageData]];
    cell.retweetedFlag = tweet.retweetedFlag;
    cell.favoriedFlag = tweet.favoritedFlag;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TweetVC *tvc = [[TweetVC alloc] init];
    tvc.currentTweet = currentTweet;
